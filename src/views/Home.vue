        ...
        <template #content>
          <div class="mt-0 mb-4 text-500 text-2xl line-height-2">
            <p>
              ...
              developer in this regard, starting as a self taught programmer to
              becoming the Development Liason at Toolkit Websites in the UK.
            </p>
            <p>
            ...
            <p>
              I currently use VueJS 3 for the website build, including a number
              of plugins and extras that make it even better. For the user
              created content I use Sanity.io which is a customizable CMS that I
              will explain further below. The backend (or server hosting) is
              more open as it is dependant on a few different factors.
            </p>
          </div>
        </template>
        <template #icons>
        ...
        <template #content>
          <div class="mt-0 mb-4 text-500 text-2xl line-height-2">
            <p>
              ...
              Google (i.e. Bing, Yahoo etc.) nothing comes close to them in
            ...
            <p>
              ...
              highly specialized and ever-changing landscape. Google keeps there
              algorithms secret but do let us know in generalities what helps
              and what costs placement on a Google search result. Aside from
              paid advertisements which are at the top of most searches,
              research shows that the top 3 results count for over 90% of
              engagement.
            </p>
            <p>
              Before completing a website, I QA the entire thing through various
              SEO tools to see if there is anything that could improve a
              websites score. Speed, responsiveness, image size and many other
              aspects are all considered as a basic way to get a very good
              score.
            </p>
          </div>
        </template>
